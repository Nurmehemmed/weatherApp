...
const SkeletonWeatherCard: FC = () => {
  return (
    <div className="animate-pulse h-72 md:h-[300px] w-full p-5 md:px-10 lg:w-[817px] bg-gradient-1 shadow rounded-[32px] mt-8 mx-auto select-none group overflow-hidden ">
